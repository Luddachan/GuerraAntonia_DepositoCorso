# ==========================================
# 3. CLASSE CONTROLLO MILITARE
# ==========================================
# Questa classe usa l'EREDITARIETÀ MULTIPLA.
# Significa che eredita i metodi da tutte le classi elencate tra parentesi.

from unita_militare import UnitaMilitare
from supporto_logistico import SupportoLogistico
...
class ControlloMilitare (Fanteria, Artiglieria, SupportoLogistico, Ricognizione, Cavalleria):
